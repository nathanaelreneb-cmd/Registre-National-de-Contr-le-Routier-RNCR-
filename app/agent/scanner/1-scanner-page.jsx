  ...
  return (
    <div className="shell">
      ...
      <div className="content">
        ...
        <label
          htmlFor="entree-photo-qr"
          className="btn secondaire"
          style={{ opacity: analyseEnCours ? 0.6 : 1, pointerEvents: analyseEnCours ? 'none' : 'auto' }}
        >
        ...
        {/* Zone technique utilisée par html5-qrcode pour analyser une image — doit rester dans la mise en page (pas display:none) pour que la librairie puisse lire l'image */}
        <div
