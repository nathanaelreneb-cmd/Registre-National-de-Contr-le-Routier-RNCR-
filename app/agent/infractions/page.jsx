...
export default function Infractions(){
 ...
 const [conducteurs,setConducteurs]=useState([]); const [engins,setEngins]=useState([]); const [agentId,setAgentId]=useState(null); const [form,setForm]=useState({numero_pv:'',conducteur_id:'',engin_id:'',type_infraction:'vitesse',lieu:'',description:'',montant:'',points_retires:'0'});
